...
def main():
    ...
    log.write(
        'inst_name,model_name,dt_model,dt_solve,dt_relax,solved,val,val_relax,servers,fireups\n'
    )
...
maximal server count = {ub_servers}'''
            ...
            for model_name, build in [
                ...
                log.write(
                    f'{inst_name},{model_name},{dt_model},{dt_solve},{dt_relax},{solved},{val:.0f},{val_relax},{servers:.0f},{fireups:.0f}\n'
                )
                log.flush()
